...
export default function CrCoorLoanApplication({ pendingLoans }: GmLoanApplicationProps) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs} headerRight={<LiveClock />}>
      <Head title="Loan Applications – Credit Coordinator" />
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Review and validate member loan requests awaiting Credit Coordinator approval
            </p>
          </div>
          <Link
            href="/dashboard"
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/dashboards/CreditCom/Loan/${loan.id}/view`}>
                            View
                          </Link>
                        </Button>
                      </td>
            ...
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-sm text-muted-foreground text-center">
                {searchTerm
                  ...
                  : 'There are currently no loan applications awaiting Credit Coordinator review.'
                }
              </p>
              {!searchTerm && (
                <Button
                ...
                >
                  <Link href="/dashboards/CreditCom/CreditComDashboard">
                    Return to Dashboard
                  </Link>
                </Button>
              )}
