...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Completed Loans', href: '/dashboards/HR/HRCompletedLoan' }];
        ...
        <AppLayout breadcrumbs={breadcrumbs} headerRight={<LiveClock />}>
            ...
            <div className="print-area flex flex-1 flex-col gap-6 p-6">
                <div className="print-only hidden border-b border-slate-300 pb-4">
                    ...
                    <p className="text-sm text-slate-600">HR Completed Loans Report</p>
