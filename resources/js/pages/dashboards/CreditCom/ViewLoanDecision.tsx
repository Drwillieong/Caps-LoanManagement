...
interface CreditComViewLoanDecisionProps {
    loan: Loan;
}

export default function CreditComViewLoanDecision() {
    const props = usePage().props as unknown as CreditComViewLoanDecisionProps;
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs} headerRight={<LiveClock />}>
            <Head title="Loan Decision Details - Credit Coordinator" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                            View details of loan application decision made by Credit Coordinator
                        </p>
                    </div>
                    <Link
                        href="/dashboards/CreditCom/ApprovedHistory"
                    ...
                    <CardContent className="pt-6">
                        ...
                        {loan.remarks && (
                            <div className="mt-4 pt-4 border-t">
                                <p className="text-sm font-medium">Credit Coordinator Decision Remarks:</p>
